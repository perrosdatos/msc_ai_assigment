...
class TSPGA:
    ...
    def tradditional_crossover(self, dna_a, dna_b, crossover_thd = None):
        ...
        if random.uniform(0,1) <= self.mutation_thd:
    ...
    def __crossover_and_mutation(self):
        ...
        with mp.Pool(mp.cpu_count()) as pool:
            children_list = pool.starmap(self.tradditional_crossover, list(permutations(
        ...
        new_members = reduce(lambda a,b : a+b, children_list)
        return new_members